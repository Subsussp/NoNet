                ...
                {(isMenuOpen || showList) && (
                    ...
                    >
                        ...
                        {menuItems.map((Obj,index)=>{
                            ...
                            return <li key={index} onClick={() => Obj.link && navigate(`${Obj.link}`)}  className="w-full cursor-pointe flex w-full items-center space-x-3 px-4 py-2 text-left flex items-center justify-between text-dropitems hover:bg-dropitems hover:text-mainele">
                                    <span >{Obj.icon}</span>
