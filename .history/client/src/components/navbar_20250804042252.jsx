                ...
                {(isMenuOpen || showList) && (
                    ...
                    >
                        ...
                        {menuItems.map((Obj,index)=>{
                            ...
                            return <li key={index}       onClick={() => navigate(`/items/${item._id}`)}  className="w-full px-4 py-2 text-left flex items-center justify-between text-dropitems hover:bg-dropitems hover:text-mainele">
