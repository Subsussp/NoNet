...
export function Form({onClose,formData2,setFormData2,showForm,handleQuantityChange,handleImageChange, handleChange, formData, operation, handleSubmit ,refresh}) {
  ...
  return (
//         <div id={`${operation}-dv`}>
//             <form onSubmit={handleSubmit} className={`${operation}-fm flex items-center`}>
//                 {operation == 'Update' ? 
//                 <div className="image-container soso">
//                     <img draggable='false'
//                     src={formData.img[0]}
//                     alt={`${formData.name} photo`}
//                     className={`product-image ${formData.img[1] ? 'opacity-100 group-hover:opacity-0' : ''}`}
//                     />
//                     <div> 
...
//                 ): ''} </div>
//             </div> :<></>}
//                 <PhotoDropdown handleChange={handleChange} formdata={formData}/>
...
//                     </div>
//             <div className="input-container">
//                     <input id={'price'} className="input-field"
//                         type="number"
//                         name="price"
...
//                         </div>
//                         <div className="input-container">
//                     <input id={'material'} className="input-field"
//                         type="text"
//                         name="material"
...
//                 <div className="input-container">
//                 <input id={'catg'} className="input-field"
//                     type="text"
//                     name="catg"
//                     value={formData.catg}
//                     onChange={handleChange}
...
//                     <div className="input-container">
//                         <input id={'Description'} className="input-field"
//                         type="text"
//                         name="desc"
//                         value={formData.desc}
//                         onChange={handleChange}
//                         required />
//                     <label htmlFor="Description" className="floating-label">Description</label></div>
//                 {operation == 'Add' ? <Options handleChange={handleChange}/> : ''}
//                 </div>
//                 <div className="last2">
//                     <div className="last">
//                         <button type="submit" style={{'width':'130px',padding:'0.5rem 1rem'}} id={`${operation}-button`} >{operation}</button>
//                     <div style={{'maxWidth':'fit-content'}} className="left flex items-center rounded border border-gray-200 dark:border-gray-800">
//                         <label htmlFor="Quantity" className="sr-only"> Quantity </label>
//                             <button
//                                 type="button"
//                                 onClick={() => handleQuantityChange(formData.quantity <= 0 ? 0 : -1)}
//                                 className="size-10 leading-10 text-gray-600 transition hover:opacity-100 dark:text-gray-300">
//                                 &minus;
//                             </button>
//                             <input
//                                 type="number"
...
//                             </button>
//                     </div>
//                         {showForm ? <button  style={{'width':'130px',padding:'0.5rem 1rem'}} onClick={onClose}>Close Panel</button> : ''} </div>
//                             <input
//                                 multiple
